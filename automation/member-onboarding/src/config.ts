...
const googleFormConfigSchema = z.object({
  ...
  phoneSheetName: z.string().min(1).default("번호"),
  phoneSourceColumn: z.string().min(1).optional(),
  emailSheetName: z.string().min(1).default("메일"),
  emailSourceColumn: z.string().min(1).optional(),
